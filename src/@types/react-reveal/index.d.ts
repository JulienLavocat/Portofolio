...
declare module "react-reveal" {
	...
	export class Flash extends React.Component<RevealProps> {}

	export class HeadShake extends React.Component<RevealProps> {}

	export class Jello extends React.Component<RevealProps> {}

	export class Pulse extends React.Component<RevealProps> {}

	export class RubberBand extends React.Component<RevealProps> {}

	export class Shake extends React.Component<RevealProps> {}

	export class Spin extends React.Component<RevealProps> {}

	export class Swing extends React.Component<RevealProps> {}

	export class Tada extends React.Component<RevealProps> {}

	export class Animation extends React.Component<RevealProps> {}
}
